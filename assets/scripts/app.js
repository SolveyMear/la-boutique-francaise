...
function cart() {
  ...
  if (totalDue <= 50) {
    document.getElementById("totalDue").style.color = "green";
  } else if (totalDue > 50 && totalDue <= 75) {
    document.getElementById("totalDue").style.color = "orange";
  } else if (totalDue > 75) {
    document.getElementById("totalDue").style.color = "red";
  }
...
function showAllUsers() {
  ...
  users.forEach((user) => {
    ...
    const userImage = new Image(200, 200);
